/// \mainpage
/// # libnd: Fast Runtime-Flexible Multi-dimensional Arrays and Views in C++.
///
#pragma once
#ifndef LIBND_MDARRAY_HPP
#define LIBND_MDARRAY_HPP
...
namespace libnd
{
    ...
    enum StringStyle
    {
        TableStyle,
        MatrixStyle
    }; ///< Flag to be used with the member function asString() of View.
    enum CoordinateOrder
    {
        FirstMajorOrder,
        LastMajorOrder
    }; ///< Flag setting the order of coordinate tuples.
    ...
    using ConstView = View<T, true, A>;
    template <class T, bool isConst, class A = std::allocator<std::size_t>>
    class Iterator;
    template <class T, class A = std::allocator<std::size_t>>
    class MDArray;

// assertion testing
#ifdef NDEBUG
    const bool MDARRAY_NO_DEBUG = true;    ///< General assertion testing disabled.
    const bool MDARRAY_NO_ARG_TEST = true; ///< Argument testing disabled.
#else
    const bool MDARRAY_NO_DEBUG = false;    ///< General assertion testing enabled.
    const bool MDARRAY_NO_ARG_TEST = false; ///< Argument testing enabled.
#endif
    ...
    namespace MDArray_detail
    {
        ...
        // geometry of views
        template <class A = std::allocator<std::size_t>>
        class Geometry;
        ...
        struct Plus
        {
            U operator()(const T1 &x, const T2 &y) const { return x + y; }
        };
        template <class T1, class T2, class U>
        struct Minus
        {
    ...
    /// MDArray. With the help of a view, data in a subset of memory can
    ...
    public:
        ...
        typedef typename MDArray_detail::IfBool<isConst, const T *, T *>::type pointer;
        typedef const T *const_pointer;
        typedef typename MDArray_detail::IfBool<isConst, const T &, T &>::type reference;
    ...
    private:
        typedef typename MDArray_detail::Geometry<A> geometry_type;
        ...
        // \cond suppress_doxygen
        template <bool isConstTo, class TFrom, class TTo, class AFrom, class ATo>
        friend struct MDArray_detail::AssignmentOperatorHelper;
        friend struct MDArray_detail::AccessOperatorHelper<true>;
        friend struct MDArray_detail::AccessOperatorHelper<false>;
        ...
        friend void MDArray_detail::operate(View<T1, false, Alocal> &v, const ViewExpression<E, T2> &expression, Functor f);
        // \endcond end suppress_doxygen
    };

    /// STL-compliant random access iterator for View and MDArray.
    ///
    ...
    public:
        ...
        typedef typename MDArray_detail::IfBool<isConst, const View<T, true, A> *,
    ...
    public:
        ...
        MDArray(const allocator_type & = allocator_type());
        MDArray(const T &, const CoordinateOrder & = defaultOrder,
                const allocator_type & = allocator_type());
        template <class ShapeIterator>
        MDArray(ShapeIterator, ShapeIterator, const T & = T(),
                const CoordinateOrder & = defaultOrder,
                const allocator_type & = allocator_type());
        template <class ShapeIterator>
        MDArray(const InitializationSkipping &, ShapeIterator, ShapeIterator,
                const CoordinateOrder & = defaultOrder,
                const allocator_type & = allocator_type());
        MDArray(std::initializer_list<std::size_t>, const T & = T(),
                const CoordinateOrder & = defaultOrder,
                const allocator_type & = allocator_type());
        MDArray(const MDArray<T, A> &);
        template <class E, class Te>
        MDArray(const ViewExpression<E, Te> &,
                const allocator_type & = allocator_type());
        template <class TLocal, bool isConstLocal, class ALocal>
        MDArray(const View<TLocal, isConstLocal, ALocal> &);
        ~MDArray();

        // assignment
        MDArray<T, A> &operator=(const T &);
        MDArray<T, A> &operator=(const MDArray<T, A> &); // over-write default
        template <class TLocal, bool isConstLocal, class ALocal>
        MDArray<T, A> &operator=(const View<TLocal, isConstLocal, ALocal> &);
        template <class E, class Te>
        MDArray<T, A> &operator=(const ViewExpression<E, Te> &);
        void assign(const allocator_type & = allocator_type());
        ...
        std::size_t &out) const
    {
        ...
        {
            MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || static_cast<std::size_t>(*it) < shape(j));
    ...
    View<T, isConst, A>::indexToCoordinates(
        ...
        CoordinateIterator outit) const
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || this->dimension() > 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || index < this->size());
        ...
        std::size_t &out) const
    {
        ...
        else
        {
            ...
            { // last major order
                if (this->dimension() == 0)
                {
                    MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || index == 0);
                    return;
                }
                else
                {
        ...
        const allocator_type &allocator)
    {
        ...
        // call
        geometry_ = typename MDArray_detail::Geometry<A>(begin, end,
    ...
    View<T, isConst, A>::operator()(
        U u)
    {
        return MDArray_detail::AccessOperatorHelper<std::numeric_limits<U>::is_integer>::execute(*this, u);
    }
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || (value < shape(Dim - 1)));
    ...
    View<T, isConst, A>::elementAccessHelper(
        ...
        const Args... args)
    {
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || (value < shape(Dim - 1 - sizeof...(args))));
        ...
        const std::size_t value)
    {
        ...
        if (dimension() == 0)
        {
            MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || value == 0);
            return data_[0];
        }
        else
        {
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || (data_ != 0 && sizeof...(args) + 1 == dimension()));
        ...
        const Args... args) const
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || (data_ != 0 && sizeof...(args) + 1 == dimension()));
        return data_[strides(0) * static_cast<std::size_t>(value) + static_cast<std::size_t>(elementAccessHelper(sizeof...(args) + 1, args...))];
    }
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || this->data_ != 0);
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || data_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || dimension < this->dimension());
    ...
    {
        testInvariant();
        MDArray_detail::AssignmentOperatorHelper<isConst, T, T, A, A>::execute(in, *this);
        testInvariant();
        return *this;
    }
    ...
    {
        testInvariant();
        MDArray_detail::AssignmentOperatorHelper<isConst, TLocal, T, ALocal, A>::execute(in, *this);
        testInvariant();
        return *this;
    }
        ...
        const T &value)
    {
        ...
        if (isSimple())
        {
            ...
            MDArray_detail::OperateHelperBinaryScalar<1, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 2)
            MDArray_detail::OperateHelperBinaryScalar<2, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 3)
            MDArray_detail::OperateHelperBinaryScalar<3, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 4)
            MDArray_detail::OperateHelperBinaryScalar<4, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 5)
            MDArray_detail::OperateHelperBinaryScalar<5, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 6)
            MDArray_detail::OperateHelperBinaryScalar<6, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 7)
            MDArray_detail::OperateHelperBinaryScalar<7, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 8)
            MDArray_detail::OperateHelperBinaryScalar<8, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 9)
            MDArray_detail::OperateHelperBinaryScalar<9, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else if (dimension() == 10)
            MDArray_detail::OperateHelperBinaryScalar<10, MDArray_detail::Assign<T, T>, T, T, A>::operate(*this, value, MDArray_detail::Assign<T, T>(), data_);
        else
        {
    ...
    {
        MDArray_detail::operate(*this, expression, MDArray_detail::Assign<T, Te>());
        return *this;
    }
    ...
    View<T, isConst, A>::view(
        BaseIterator bit,
        ShapeIterator sit,
        const CoordinateOrder &internalCoordinateOrder) const
    {
        View<T, isConst, A> v;
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || isSimple());
        if (!MDARRAY_NO_ARG_TEST)
        {
            std::size_t size = std::accumulate(begin, end, static_cast<std::size_t>(1),
                                               std::multiplies<std::size_t>());
            MDArray_detail::Assert(size == this->size());
        }
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || (dimension < this->dimension() && value < shape(dimension)));
        if (this->dimension() == 1)
        {
            View v(&((*this)(value)));
        ...
        else
        {
            ...
            MDArray_detail::stridesFromShape(v.geometry_.shapeBegin(), v.geometry_.shapeEnd(),
        ...
        if (dimension() != 0)
        {
            ...
            if (newDimension != dimension())
            {
                ...
                else
                {
                    ...
                    MDArray_detail::stridesFromShape(geometry_.shapeBegin(), geometry_.shapeEnd(),
        ...
        CoordinateIterator begin)
    {
        ...
        if (!MDARRAY_NO_ARG_TEST)
        {
            MDArray_detail::Assert(dimension() != 0);
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST ||
    ...
    {
        testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || dimension() != 0);
    ...
    View<T, isConst, A>::testInvariant() const
    {
        if (!MDARRAY_NO_DEBUG)
        {
            ...
            {
                MDArray_detail::Assert(geometry_.isSimple() == true);
                if (data_ != 0)
                { // scalar
                    MDArray_detail::Assert(geometry_.size() == 1);
                }
            }
            else
            {
                MDArray_detail::Assert(data_ != 0);
                ...
                MDArray_detail::Assert(geometry_.size() == testSize);
                ...
                if (geometry_.coordinateOrder() == FirstMajorOrder)
                {
                    ...
                    for (std::size_t j = 0; j < geometry_.dimension(); ++j)
                    {
                        MDArray_detail::Assert(geometry_.shapeStrides(geometry_.dimension() - j - 1) == tmp);
                ...
                else
                {
                    ...
                    for (std::size_t j = 0; j < geometry_.dimension(); ++j)
                    {
                        MDArray_detail::Assert(geometry_.shapeStrides(j) == tmp);
                ...
                if (geometry_.isSimple())
                {
                    for (std::size_t j = 0; j < geometry_.dimension(); ++j)
                    {
                        MDArray_detail::Assert(geometry_.strides(j) == geometry_.shapeStrides(j));
                    }
                }
            }
        }
    ...
    inline bool View<T, isConst, A>::overlaps(
        const View<TLocal, isConstLocal, ALocal> &v) const
    {
        testInvariant();
        if (!MDARRAY_NO_ARG_TEST)
        {
        ...
        else
        {
            ...
            if ((dataPointer_ <= vDataPointer_ && vDataPointer_ <= maxPointer) || (vDataPointer_ <= dataPointer_ && dataPointer_ <= maxPointerV))
            {
                return true;
            }
        }
    ...
    {
        MDArray_detail::operate(v, w, MDArray_detail::PlusEqual<T1, T2>());
        return v;
    }
    ...
    operator++(
        View<T, false, A> &v)
    {
        MDArray_detail::operate(v, MDArray_detail::PrefixIncrement<T>());
        return v;
    }
    ...
    {
        MDArray<T, A> out = in;
        MDArray_detail::operate(in, MDArray_detail::PostfixIncrement<T>());
        return out;
    }
    ...
    operator-=(
        ...
        const View<T2, isConst, A> &w)
    {
        MDArray_detail::operate(v, w, MDArray_detail::MinusEqual<T1, T2>());
        return v;
    }
    ...
    operator--(
        View<T, false, A> &v)
    {
        MDArray_detail::operate(v, MDArray_detail::PrefixDecrement<T>());
        return v;
    }
    ...
    {
        MDArray<T, A> out = in;
        MDArray_detail::operate(in, MDArray_detail::PostfixDecrement<T>());
        return out;
    }
    ...
    operator*=(
        ...
        const View<T2, isConst, A> &w)
    {
        MDArray_detail::operate(v, w, MDArray_detail::TimesEqual<T1, T2>());
        return v;
    }
    ...
    operator/=(
        ...
        const View<T2, isConst, A> &w)
    {
        MDArray_detail::operate(v, w, MDArray_detail::DividedByEqual<T1, T2>());
        return v;
    }

    template <class E1, class T1, class E2, class T2>
    inline const BinaryViewExpression<E1, T1, E2, T2, MDArray_detail::Plus<T1, T2, typename MDArray_detail::PromoteType<T1, T2>::type>>
    operator+(
        const ViewExpression<E1, T1> &expression1,
        const ViewExpression<E2, T2> &expression2)
    {
        typedef typename MDArray_detail::PromoteType<T1, T2>::type promoted_type;
        typedef MDArray_detail::Plus<T1, T2, promoted_type> Functor;
    ...
    operator+(
        const ViewExpression<E, T> &expression) // unary
    {
        return expression;
    }

#define MDARRAY_UNARY_OPERATOR(datatype, operation, functorname)                            \
    template <class T, class A>                                                             \
    inline View<T, false, A> &                                                              \
    operator operation(                                                                     \
        View<T, false, A> &v,                                                               \
        const datatype &x)                                                                  \
    {                                                                                       \
        MDArray_detail::operate(v, static_cast<T>(x), MDArray_detail::functorname<T, T>()); \
        return v;                                                                           \
    }

#define MDARRAY_UNARY_OPERATOR_ALL_TYPES(op, functorname)   \
    MDARRAY_UNARY_OPERATOR(char, op, functorname)           \
    MDARRAY_UNARY_OPERATOR(unsigned char, op, functorname)  \
    MDARRAY_UNARY_OPERATOR(short, op, functorname)          \
    MDARRAY_UNARY_OPERATOR(unsigned short, op, functorname) \
    MDARRAY_UNARY_OPERATOR(int, op, functorname)            \
    MDARRAY_UNARY_OPERATOR(unsigned int, op, functorname)   \
    MDARRAY_UNARY_OPERATOR(long, op, functorname)           \
    MDARRAY_UNARY_OPERATOR(unsigned long, op, functorname)  \
    MDARRAY_UNARY_OPERATOR(float, op, functorname)          \
    MDARRAY_UNARY_OPERATOR(double, op, functorname)         \
    MDARRAY_UNARY_OPERATOR(long double, op, functorname)

    MDARRAY_UNARY_OPERATOR_ALL_TYPES(+=, PlusEqual)
    MDARRAY_UNARY_OPERATOR_ALL_TYPES(-=, MinusEqual)
    MDARRAY_UNARY_OPERATOR_ALL_TYPES(*=, TimesEqual)
    MDARRAY_UNARY_OPERATOR_ALL_TYPES(/=, DividedByEqual)

    template <class E1, class T1, class E2, class T2>
    inline const BinaryViewExpression<E1, T1, E2, T2,
                                      MDArray_detail::Minus<T1, T2, typename MDArray_detail::PromoteType<T1, T2>::type>>
    operator-(
        const ViewExpression<E1, T1> &expression1,
        const ViewExpression<E2, T2> &expression2)
    {
        return BinaryViewExpression<E1, T1, E2, T2,
                                    MDArray_detail::Minus<T1, T2,
                                                          typename MDArray_detail::PromoteType<T1, T2>::type>>(
            expression1, expression2);
    }

    template <class E, class T>
    inline const UnaryViewExpression<E, T, MDArray_detail::Negate<T>>
    operator-(
        const ViewExpression<E, T> &expression) // unary
    {
        return UnaryViewExpression<E, T, MDArray_detail::Negate<T>>(
            expression);
    }

    template <class E1, class T1, class E2, class T2>
    inline const BinaryViewExpression<E1, T1, E2, T2,
                                      MDArray_detail::Times<T1, T2, typename MDArray_detail::PromoteType<T1, T2>::type>>
    operator*(
        const ViewExpression<E1, T1> &expression1,
        const ViewExpression<E2, T2> &expression2)
    {
        return BinaryViewExpression<E1, T1, E2, T2,
                                    MDArray_detail::Times<T1, T2,
                                                          typename MDArray_detail::PromoteType<T1, T2>::type>>(
            expression1, expression2);
    }
    ...
    template <class E1, class T1, class E2, class T2>
    inline const BinaryViewExpression<E1, T1, E2, T2,
                                      MDArray_detail::DividedBy<T1, T2, typename MDArray_detail::PromoteType<T1, T2>::type>>
    operator/(
        const ViewExpression<E1, T1> &expression1,
        const ViewExpression<E2, T2> &expression2)
    {
        return BinaryViewExpression<E1, T1, E2, T2,
                                    MDArray_detail::DividedBy<T1, T2,
                                                              typename MDArray_detail::PromoteType<T1, T2>::type>>(
            expression1, expression2);
    }

#define MDARRAY_BINARY_OPERATOR(datatype, operation, functorname)                                                          \
    template <class E, class T>                                                                                            \
    inline const BinaryViewExpressionScalarSecond<                                                                         \
        E, T, datatype, MDArray_detail::functorname<T, datatype, typename MDArray_detail::PromoteType<T, datatype>::type>> \
    operator operation(                                                                                                    \
        const ViewExpression<E, T> &expression,                                                                            \
        const datatype &scalar)                                                                                            \
    {                                                                                                                      \
        typedef typename MDArray_detail::PromoteType<T, datatype>::type                                                    \
            promoted_type;                                                                                                 \
        typedef MDArray_detail::functorname<T, datatype, promoted_type> Functor;                                           \
    ...
    inline const BinaryViewExpressionScalarFirst<                                                                          \
        E, T, datatype, MDArray_detail::functorname<datatype, T, typename MDArray_detail::PromoteType<datatype, T>::type>> \
    operator operation(                                                                                                    \
        const datatype &scalar,                                                                                            \
        const ViewExpression<E, T> &expression)                                                                            \
    {                                                                                                                      \
        typedef typename MDArray_detail::PromoteType<T, datatype>::type                                                    \
            promoted_type;                                                                                                 \
        typedef MDArray_detail::functorname<datatype, T, promoted_type> Functor;                                           \
        typedef BinaryViewExpressionScalarFirst<E, T, datatype, Functor>                                                   \
            expression_type;                                                                                               \
        return expression_type(expression, scalar);                                                                        \
    }

#define MDARRAY_BINARY_OPERATOR_ALL_TYPES(op, functorname)   \
    MDARRAY_BINARY_OPERATOR(char, op, functorname)           \
    MDARRAY_BINARY_OPERATOR(unsigned char, op, functorname)  \
    MDARRAY_BINARY_OPERATOR(short, op, functorname)          \
    MDARRAY_BINARY_OPERATOR(unsigned short, op, functorname) \
    MDARRAY_BINARY_OPERATOR(int, op, functorname)            \
    MDARRAY_BINARY_OPERATOR(unsigned int, op, functorname)   \
    MDARRAY_BINARY_OPERATOR(long, op, functorname)           \
    MDARRAY_BINARY_OPERATOR(unsigned long, op, functorname)  \
    MDARRAY_BINARY_OPERATOR(float, op, functorname)          \
    MDARRAY_BINARY_OPERATOR(double, op, functorname)         \
    MDARRAY_BINARY_OPERATOR(long double, op, functorname)

    MDARRAY_BINARY_OPERATOR_ALL_TYPES(+, Plus)
    MDARRAY_BINARY_OPERATOR_ALL_TYPES(-, Minus)
    MDARRAY_BINARY_OPERATOR_ALL_TYPES(*, Times)
    MDARRAY_BINARY_OPERATOR_ALL_TYPES(/, DividedBy)

    // implementation of MDArray

    /// Clear MDArray.
    ///
    /// Leaves the MDArray in the same state as if the empty constructor
    ...
    /// LastMajorOrder is to be used. As the MDArray can be resized after
    /// construction, the coordinate order has to be set even for a
    /// 0-dimensional MDArray.
    /// \param allocator Allocator.
    ///
    template <class T, class A>
    inline MDArray<T, A>::MDArray(
    ...
    /// Copy from a MDArray.
    ///
    /// \param in MDArray (source).
    ///
    template <class T, class A>
    inline MDArray<T, A>::MDArray(
        const MDArray<T, A> &in)
        ...
        : dataAllocator_()
    {
        ...
        if (in.isSimple() && MDArray_detail::IsEqual<T, TLocal>::type)
        {
            memcpy(this->data_, in.data_, (in.size()) * sizeof(T));
        }
        else
    ...
    /// Construct MDArray from ViewExpression.
    ///
        ...
        : dataAllocator_(allocator)
    {
        ...
        if (e.dimension() == 0)
        {
            MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || e.size() < 2);
            this->data_[0] = static_cast<T>(e(0));
        }
        else
        {
            MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || e.size() != 0);
            MDArray_detail::operate(*this, e, MDArray_detail::Assign<T, Te>());
        }
        testInvariant();
    }

    /// Construct MDArray with initialization.
    ///
    /// \param begin Iterator to the beginning of a sequence that determines
    /// the shape.
    /// \param end Iterator to the end of that sequence.
        ...
        : dataAllocator_(allocator)
    {
        std::size_t size = std::accumulate(begin, end, static_cast<std::size_t>(1),
                                           std::multiplies<std::size_t>());
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || size != 0);
    ...
    /// Construct MDArray without initialization.
    ///
        ...
        const View<TLocal, isConstLocal, ALocal> &in)
    {
        ...
        { // no self-assignment
            ...
            {
                MDArray<T, A> m = in; // temporary copy
                (*this) = m;
            }
            else
            {
                ...
                if (in.isSimple() && MDArray_detail::IsEqual<T, TLocal>::type)
                {
                    ...
                    MDArray_detail::OperateHelperBinary<1, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 2)
                    MDArray_detail::OperateHelperBinary<2, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 3)
                    MDArray_detail::OperateHelperBinary<3, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 4)
                    MDArray_detail::OperateHelperBinary<4, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 5)
                    MDArray_detail::OperateHelperBinary<5, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 6)
                    MDArray_detail::OperateHelperBinary<6, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 7)
                    MDArray_detail::OperateHelperBinary<7, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 8)
                    MDArray_detail::OperateHelperBinary<8, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 9)
                    MDArray_detail::OperateHelperBinary<9, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else if (in.dimension() == 10)
                    MDArray_detail::OperateHelperBinary<10, MDArray_detail::Assign<T, TLocal>, T, TLocal, isConstLocal, A, ALocal>::operate(*this, in, MDArray_detail::Assign<T, TLocal>(), this->data_, &in(0));
                else
                {
                    typename View<TLocal, isConstLocal, ALocal>::const_iterator it = in.begin();
                    for (std::size_t j = 0; j < this->size(); ++j, ++it)
        ...
        const ViewExpression<E, Te> &expression)
    {
        ...
        {
            MDArray<T, A> m(expression); // temporary copy
        ...
        else
        {
            ...
            {
                MDArray_detail::stridesFromShape(this->geometry_.shapeBegin(), this->geometry_.shapeEnd(),
        ...
        const T &value)
    {
        ...
        for (ShapeIterator it = begin; it != end; ++it)
        {
            ...
            MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || x > 0);
    ...
    template <class T, class A>
    inline void
    MDArray<T, A>::testInvariant() const
    {
        View<T, false, A>::testInvariant();
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || this->geometry_.isSimple());
    }
    ...
    Iterator<T, isConst, A>::testInvariant() const
    {
        if (!MDARRAY_NO_DEBUG)
        {
            if (view_ == 0)
            {
                MDArray_detail::Assert(coordinates_.size() == 0 && index_ == 0 && pointer_ == 0);
            }
            else
            {
                if (view_->size() == 0)
                ...
                { // initialized view
                    MDArray_detail::Assert(index_ >= 0 && index_ <= view_->size());
                    if (index_ == view_->size())
                    { // end iterator
                        MDArray_detail::Assert(pointer_ == &((*view_)(view_->size() - 1)) + 1);
                    }
                    else
                    {
                        MDArray_detail::Assert(pointer_ == &((*view_)(index_)));
                    }
                    if (!view_->isSimple())
                    {
                        MDArray_detail::Assert(coordinates_.size() == view_->dimension());
                        if (index_ == view_->size())
                        { // end iterator
                            if (view_->coordinateOrder() == LastMajorOrder)
                            {
                                MDArray_detail::Assert(coordinates_[0] == view_->shape(0));
                                for (std::size_t j = 1; j < coordinates_.size(); ++j)
                                {
                                    MDArray_detail::Assert(coordinates_[j] == view_->shape(j) - 1);
                                }
                            }
                            else
                            { // FirstMajorOrder
                                std::size_t d = view_->dimension() - 1;
                                MDArray_detail::Assert(coordinates_[d] == view_->shape(d));
                        ...
                        else
                        {
                            ...
                            {
                                MDArray_detail::Assert(coordinates_[j] == testCoord[j]);
                            }
                        }
                    }
                }
    ...
    // not be possible to construct a mutable iterator on constant data.
    {
        ...
        else
        {
            if (view.isSimple())
            {
                MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || index <= view.size());
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || (view_ != 0 && index_ < view_->size()));
        return *pointer_;
    }
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || (view_ != 0 && x + index_ < view_->size()));
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        if (index_ < view_->size())
        { // view initialized and iterator not at the end
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || static_cast<difference_type>(index_) >= x);
        index_ -= x;
        if (view_->isSimple())
        {
            pointer_ -= x;
    ...
    Iterator<T, isConst, A>::operator--()
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || (view_ != 0 && index_ > 0));
        --index_;
        if (view_->isSimple())
        {
            --pointer_;
    ...
    Iterator<T, isConst, A>::operator-(
        const Iterator<T, isConstLocal, A> &it) const
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || it.view_ != 0);
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || (it.view_ != 0 && (void *)it.view_ == (void *)view_));
    ...
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || (it.view_ != 0 && it.view_ == view_));
        return (index_ < it.index_);
    }
    ...
    Iterator<T, isConst, A>::coordinate(
        CoordinateIterator it) const
    {
        MDArray_detail::Assert(MDARRAY_NO_DEBUG || view_ != 0);
        MDArray_detail::Assert(MDARRAY_NO_ARG_TEST || index_ < view_->size());
        if (view_->isSimple())
        {
    ...
    public:
        ...
        typedef typename MDArray_detail::PromoteType<T1, T2>::type value_type;
              ...
              binaryFunctor_(BinaryFunctor())
        {
            if (!MDARRAY_NO_DEBUG)
            {
                MDArray_detail::Assert(e1_.size() != 0 && e2_.size() != 0);
                MDArray_detail::Assert(e1_.dimension() == e2_.dimension());
                for (std::size_t j = 0; j < e1_.dimension(); ++j)
                {
                    MDArray_detail::Assert(e1_.shape(j) == e2_.shape(j));
                }
            }
        }
        const std::size_t dimension() const
        ...
        const bool isSimple() const
        {
            return e1_.isSimple() && e2_.isSimple() && e1_.coordinateOrder() == e2_.coordinateOrder();
        }
        template <class Accessor>
    ...
    class BinaryViewExpressionScalarFirst
        : public ViewExpression<BinaryViewExpressionScalarFirst<E, T, S, BinaryFunctor>,
                                typename MDArray_detail::PromoteType<T, S>::type>
    {
    public:
        typedef E expression_type;
        typedef T value_type_1;
        typedef S scalar_type;
        typedef typename MDArray_detail::PromoteType<T, S>::type value_type;
        typedef BinaryFunctor functor_type;
    ...
    // implementation of MDArray_detail
    ...
    */
        ...
        */
        ...
        {
            Assert(MDARRAY_NO_DEBUG || j < dimension_);
            return shape_[j];
        }
        ...
        stridesFromShape(
            ...
            const CoordinateOrder &coordinateOrder)
        {
            Assert(MDARRAY_NO_ARG_TEST || std::distance(begin, end) != 0);
        ...
        struct AssignmentOperatorHelper<false, TFrom, TTo, AFrom, ATo>
        {
                ...
                View<TTo, false, ATo> &to)
            {
                ...
                if (from.overlaps(to))
                {
                    MDArray<TFrom, AFrom> m = from; // temporary copy
                    execute(m, to);
                }
                else if (from.coordinateOrder() == to.coordinateOrder() && from.isSimple() && to.isSimple() && IsEqual<TFrom, TTo>::type)
                {
                ...
                View<TTo, false, ATo> &to)
            {
                ...
                typedef typename View<TTo, false, ATo>::iterator ToIterator;
                if (static_cast<const void *>(&from) != static_cast<const void *>(&to))
                { // no self-assignment
                    if (to.data_ == 0)
                    { // if the view 'to' is not initialized
                        // initialize the view 'to' with source data
                        Assert(MDARRAY_NO_ARG_TEST || sizeof(TTo) == sizeof(TFrom));
                        to.data_ = static_cast<TTo *>(static_cast<void *>(from.data_)); // copy pointer
                        to.geometry_ = from.geometry_;
                    }
                    else
                    { // if the view 'to' is initialized
                        if (!MDARRAY_NO_ARG_TEST)
                        {
                            Assert(from.data_ != 0 && from.dimension() == to.dimension());
                            for (std::size_t j = 0; j < from.dimension(); ++j)
        ...
        struct AssignmentOperatorHelper<true, TFrom, TTo, AFrom, ATo>
        {
            ...
            {
                Assert(MDARRAY_NO_ARG_TEST || sizeof(TFrom) == sizeof(TTo));
        ...
        struct AccessOperatorHelper<true>
        {
            ...
            {
                v.testInvariant();
                Assert(MDARRAY_NO_DEBUG || v.data_ != 0);
                Assert(MDARRAY_NO_DEBUG || v.dimension() != 0 || index == 0);
                std::size_t offset;
        ...
        struct AccessOperatorHelper<false>
        {
            ...
            execute(const View<T, isConst, A> &v, U it)
            {
                v.testInvariant();
                Assert(MDARRAY_NO_DEBUG || v.data_ != 0);
                Assert(MDARRAY_NO_DEBUG || v.dimension() != 0 || *it == 0);
                std::size_t offset;
            ...
            Functor f)
        {
            ...
            else
            {
                if (v.overlaps(w))
                {
                    MDArray<T2> m = w; // temporary copy
                    operate(v, m, f);  // recursive call
                }
                else
                {
                    if (v.coordinateOrder() == w.coordinateOrder() && v.isSimple() && w.isSimple())
                    {
                        T1 *dataV = &v(0);
                        const T2 *dataW = &w(0);
                        for (std::size_t j = 0; j < v.size(); ++j)
                    ...
                    else
                    {
                        ...
                        {
                            Assert(MDARRAY_NO_DEBUG || itW.hasMore());
                            f(*itV, *itW);
                        }
                        Assert(MDARRAY_NO_DEBUG || !itW.hasMore());
                    }
            ...
            Functor f)
        {
            ...
            if (e.overlaps(v))
            {
                MDArray<T1, A> m(e); // temporary copy
                operate(v, m, f);
            }
            ...
            else if (v.isSimple() && e.isSimple() && v.coordinateOrder() == e.coordinateOrder())
            {
                for (std::size_t j = 0; j < v.size(); ++j)
                {
                    f(v[j], e[j]);
